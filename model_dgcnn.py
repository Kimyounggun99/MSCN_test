...
class PointNet(nn.Module):
    def __init__(self, args, emb_dims= 1024, output_channels=2):
...
class DGCNN(nn.Module):
    def __init__(self, k= 20, emb_dims= 1024, dropout= 0.5, output_channels= 3): # output_channels= 40 >2 수정
    ...
    def forward(self, x):
        ...
        hidden_output= self.projection(x)
...
def test():
    ...
    points = torch.randn(8, 3008, 3).to(device)
